              ...
              <CardContent sx={{ flexGrow: 1 }}>
                ...
                <Box display="flex" flexWrap="wrap" mt={2}>
                  ...
                  <Chip 
                    ...
                    label={tech.trend}
                    color={
                      tech.trend === TechnologyTrend.Emerging ? 'success' : 
                      tech.trend === TechnologyTrend.Growing ? 'primary' : 
                      tech.trend === TechnologyTrend.Stable ? 'warning' : 
                      'default'
                    }
                    size="small"
                    sx={{ mr: 1, mb: 1 }}
                ...
                {showRelatedOccupations && tech.relatedOccupations && tech.relatedOccupations.length > 0 && (
                  <Box mt={2}>
                    ...
                    <List dense disablePadding>
                      {tech.relatedOccupations.slice(0, 3).map((occupation, index) => (
                        <ListItem 
                          key={occupation.code}
                          disablePadding
                          disableGutters
